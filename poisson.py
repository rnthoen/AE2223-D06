...
def poisson(df_data, N, specimen, cycle_number, path):
    DIC_df = df_data[1]
    MTS_df = df_data[0]
    grid_x, grid_y = np.mgrid[-75:-35:200j, -70:70:200j]
    ...
    print(min(poisson_ratio.flatten()))
    print(max(poisson_ratio.flatten()))
    ...
    filename = f'Poisson/{path}/{specimen}_{N}.jpg'
